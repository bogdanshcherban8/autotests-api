...
from clients.files.files_schema import CreateFileAPISchema, CreateFileResponseSchema, GetFileResponseSchema
from fixtures.files import FileFixture
from tools.asserations.base import assert_status_code
from tools.asserations.files import assert_create_file_response, assert_get_file_response, \
...
class TestFiles:
    ...
    def test_create_file_with_empty_filename(self, files_client:FilesClient):
        request = CreateFileAPISchema(filename="",
    ...
    def test_create_file_with_empty_directory(self, files_client:FilesClient):
        request = CreateFileAPISchema(directory="",
            upload_file="./testdata/files/image.jpg")
        response=files_client.create_file_api(request)
        response_data=ValidationErrorResponseSchema.model_validate_json(response.text)
        assert_status_code(response.status_code, HTTPStatus.UNPROCESSABLE_ENTITY)
